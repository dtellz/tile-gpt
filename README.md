...
### Lightweight
When designing this project, I tried to keep it minimal, using the platform's native features to the maximum and minimizing the number of third-party dependencies.

### Electron

- This project uses the latest electron version with all the latest security patches.
...
There is only one requirement: the project expects to import renderer by `@app/renderer` name.
...
> [!TIP]
> This project is configured to use GitHub Releases to distribute updates, but you can configure whatever you need.
...
However, this project is designed to use all power of ES modules.
